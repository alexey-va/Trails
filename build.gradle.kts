...
val verifyPluginArtifact = tasks.register("verifyPluginArtifact") {
    ...
    doLast {
        ...
        listOf("Kotlin standard library 2.4.10", "JetBrains Java annotations 13.0", "arc-core and arc-core-paper 2.7.13", "bStats base and Bukkit 3.2.1")
        ...
        mapOf(
            ...
            "ru.ruscrafting.arc:arc-core" to "2.7.13",
            "ru.ruscrafting.arc:arc-core-paper" to "2.7.13",
